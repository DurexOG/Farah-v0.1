/**
 * @author uo1428
 * @support https://discord.gg/2726JugYVn | youtobe.com/@DurexxD
 * @note Dont take any type credit
 * @copyright discord.com/users/aashiqhoon all rights reserved
 */
...
let aio_server = `\nSupport:- ${`https://discord.gg/2726JugYVn`.brightGreen}`;
let Uo = `\nCoded By ${`@DurexxD`.brightCyan.bold}`;
